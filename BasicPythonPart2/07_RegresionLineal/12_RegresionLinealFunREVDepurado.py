# Guardado con el nombre de 08_RegresionLinealFunREVDepurado.py 
import numpy as np
...
def calculaxAlCuaYxxmedia():       
        ...
        xxmedia = np.mean(xcua)        
        print("\nCalcula x*xmedia	= %.3f" %xxmedia)          
        return xxmedia
...
def multiXYxyMedia(): 
        ...
        xymedia = np.mean(multixy)
        print("\nCalcula x*ymedia	= %.3f" %xymedia)   
        return xymedia
