...
if num_components<=2:
    ...
    ax.scatter3D(principalComponents_test[y_test==0,0],principalComponents_test[y_test==0,1],y_test[y_test==0] ,color = "green",marker='^',
    label='No Breast Cancer')
    ax.scatter3D(principalComponents_test[y_test==1,0],principalComponents_test[y_test==1,1],y_test[y_test==1] ,color = "red",marker='o',
    label='Breast Cancer')
...
fig = plt.figure(figsize = (10, 7))
ax = plt.axes(projection ="3d")
ax.scatter3D(principalComponents[y_train==0,0],principalComponents[y_train==0,1],y_train[y_train==0] ,color = "green",marker='^',
label='No Breast Cancer')
ax.scatter3D(principalComponents[y_train==1,0],principalComponents[y_train==1,1],y_train[y_train==1] ,color = "red",marker='o',
label='Breast Cancer')
